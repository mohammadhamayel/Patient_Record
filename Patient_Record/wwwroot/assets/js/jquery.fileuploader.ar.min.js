...
! function($) {
    ...
    $.fn.fileuploader = function(q) {
                    ...
                    redesign: function() {
                        if (o = s, n.theme && p.addClass("fileuploader-theme-" + n.theme), n.changeInput) {
                            switch ((typeof n.changeInput).toLowerCase()) {
                                case "boolean":
                                    o = $('<div class="fileuploader-input"><div style="text-align: right;" class="fileuploader-input-caption"><span>' + f._assets.textParse(n.captions.feedback) + '</span></div><div class="fileuploader-input-button"><span>' + f._assets.textParse(n.captions.button) + "</span></div></div>");
                                    break;
                                case "string":
        ...
        captions: {
            button: function(e) {
                return "اختر " + (1 == e.limit ? "ملف" : "ملفات")
            },
            feedback: function(e) {
                return "اختر " + (1 == e.limit ? "ملف" : "ملفات") + " لتحميله/ها"
            },
            feedback2: function(e) {
                return e.length + " " + (e.length > 1 ? " ملفات تم" : " ملف تم") + " تحديده/ها"
            },
            drop: "اسحب الملف لتحميله/ها",
            paste: '<div class="fileuploader-pending-loader"><div class="left-half" style="animation-duration: ${ms}s"></div><div class="spinner" style="animation-duration: ${ms}s"></div><div class="right-half" style="animation-duration: ${ms}s"></div></div> Pasting a file, click here to cancel.',
            removeConfirmation: "Are you sure you want to remove this file?",
            errors: {
                filesLimit: "فقط ${limit} ملف مسموح بتحميله.",
                filesType: "فقط ${extensions} هي الملفات المسموح بتحميلها.",
                fileSize: "${name} حجم الملف كبير! قم باختيار ملف كحجم اقصى ${fileMaxSize}MB.",
                filesSizeAll: "الملفات التي قمت باختيارها ذات حجم كبير! حجم الملف المسموح به ${maxSize} MB.",
                fileName: "الملف المسمى ${name} تم اختياره مسبقاً.",
                folderUpload: "غير مسموح لك برفع مجلد."
            }
        }
    }
}(jQuery);